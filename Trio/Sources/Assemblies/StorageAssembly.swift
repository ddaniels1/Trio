...
final class StorageAssembly: Assembly {
    func assemble(container: Container) {
        ...
        container.register(PersonalLearningStorage.self) { r in BasePersonalLearningStorage(resolver: r) }
        container.register(PersonalLearningOutcomeBackfill.self) { r in BasePersonalLearningOutcomeBackfill(resolver: r) }
